...
public class DisplayService {
	...
	public void viewTshirts(UserInputData userData, List<TshirtsData> ListOfTShirt) {
		SearchService srchTShirt = new SearchService(userData, ListOfTShirt);
		availableTShirts = srchTShirt.getListOfTShirt();
		...
		if (availableTShirts.size() == 0) {
			...
			case 1 : Collections.sort(availableTShirts,new sortByRating());
			break;
			case 2 : Collections.sort(availableTShirts,new sortByPrice());
			break;
			case 3 :Collections.sort(availableTShirts,new sortByPriceAndRating());
			break;
			default : System.out.println("\nInvalid preference.................\nThis result"
					+ " is based on default sort.\n");
			}
