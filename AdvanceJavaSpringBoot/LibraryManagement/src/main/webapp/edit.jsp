<%@page import="com.training.Model.BookDetails"%>
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
	...
	<nav
		...
		<div class="m-auto text-dark fw-bold  fs-5  ps-5 ">Edit Book Details</div>
			...
			<div class="col-12 p-3 me-4 d-flex ">
				...
				<%BookDetails book = (BookDetails) request.getAttribute("book"); %>
					...
					<div class="row py-1">
						...
						<div class="col-8">
							<input type="text" name="bookCode" required  value= <%= book.getBookCode() %> />
						</div>
					</div>
					<div class="row ">
						<div class="col-3">
						...
						<div class="col-7 ">
							<input type="text" name="bookName" required value= <%= book.getBookName() %> />
						</div>
					</div>
					<div class="row py-1">
						<div class="col-3">
						...
						<div class="col-8">
							<input type="text" name="bookAuthor" required value=<%= book.getBookAuthor() %> />
						</div>
					</div>
					<%
					...
					<div class="row py-1">
						...
						<div class="col-8">
							<input type="text" name="date" required readonly value="<%=date%>" />
						</div>
					</div>
					<div class="col-3 py-1 "
						style="width: 140px; margin-left: 100px; margin-top: 14px;">
						<button type="submit" class=" border-1 rounded-2">Update Book</button>
					</div>
				</form>
			</div>
		</div>
